 ...
 *
 * $Id: kmtrowbr 14935 May  5 17:15 2012 jquery.timepicker.js
 *
 * Depends:
 *  ui.core.js
 *  ui.datepicker.js
...
(function ($) {
    ...
    $.datepicker._selectDate = function (id, dateStr) {
        ...
        $.datepicker._updateInputTextField(target);
    };

    $.datepicker._updateInputTextField = function (target) {
        var inst = this._getInst(target[0]);
        if (inst.input) {
            inst.input.val(this._formatDate(inst));
            inst.input.trigger('change'); // fire the change event
        ...
        _generateHtml:function () {
            ...
            $('#hourSlider').slider({
                ...
                slide:function (event, ui) {
                    $.datepicker._updateInputTextField($('#' + self._inputId));
